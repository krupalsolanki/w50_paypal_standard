...
# endpoint
#
# *rm=2* is only necessary if notify_url is not set HERE (it does
# not matter whether or not it is enabled on the profile, notify_url
# should be specified here, otherwise confirm page does not
# get any transaction details at all)
$param['rm'] = 2;
$param['cbt'] = '[return]';
